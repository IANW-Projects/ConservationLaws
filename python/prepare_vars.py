...
def prepare_vars():
    ...
    I_RunOps = {'order':0, 'operator_form':'classical', 'conservation_laws':'\0', 'testcase':'\0', 'periodicx':'\0', 'peridocy':'\0', 'periodicz':'\0', 'plot_numerical_solution':'\0',  'save_fields':False, 'save_integrals_over_time':False, 'norm':'L2'}
